...
#$ -l mem_free=32    # job requires up to 1 GiB of RAM per slot
#$ -l scratch=10G      # job requires up to 60 GiB of local /scratch space
#$ -l h_rt=24:00:00   # job requires up to 2 hours of runtime
...
echo "1-9click.py START $1 END $2"
date
hostname
...
python3 1-9click.py --start $1 --end $2 
echo "End python job"
